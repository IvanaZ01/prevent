...
app.post('/auth/reset-password-request', (req, res) =>
	resetPasswordRequest(req.body, res)
);
...
// article routes
app.get('/article/search', authenticateToken, (req, res) =>
	searchArticles(req.query, res)
);
app.get('/article/:id', authenticateToken, (req, res) =>
	viewArticle(req.params.id, res)
);
...
app.put('/article/:id', authenticateToken, (req, res) =>
...
app.get('/category/:id', authenticateToken, (req, res) =>
	viewCategory(req.params.id, res)
);
...
app.delete('/category/:id', authenticateToken, (req, res) =>
